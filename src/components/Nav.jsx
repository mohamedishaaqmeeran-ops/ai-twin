...
const createMenu = [
  {
    ...
    desc: "Build your digital avatar",
    link: "/createai",
  },
  {
    icon: Mic,
    title: "Train Your Voice",
    desc: "Clone or select AI voice",
    link: "/trainvoice",
  },
  {
    icon: ShoppingBag,
    title: "Add Products",
    desc: "Upload products to sell",
    link: "/add-products",
  },
  {
    icon: Radio,
    title: "Go Live",
    desc: "Launch your AI live session",
    link: "/go-live",
  },
];
...
const solutionMenu = [
  {
    ...
    desc: "Earn with AI selling",
    link: "/creators",
  },
  {
    icon: Store,
    title: "For Brands and Shops",
    desc: "Sell products with AI live",
    link: "/brand",
  },
  {
    icon: Briefcase,
    title: "For Agencies",
    desc: "Manage multiple brands",
    link: "/agency",
  },
];
